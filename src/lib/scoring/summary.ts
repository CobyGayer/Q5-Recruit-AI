...
${!dqsResult.isQualified ? `- Disqualification Reasons: ${dqsResult.disqualificationReasons.join("; ")}` : ""}- Academic Score: ${formatSummaryScore(dqsResult.componentScores.academic, config.weight_academic)}
