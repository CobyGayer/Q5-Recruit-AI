...
- For club_level: Classify the club/league tier as one of: "mls_next", "ecnl", "ga" (Girls/Boys Academy), "ga_aspire" (Girls Academy Aspire subleague), "regional", "other", "unknown". Infer from the club name if needed (e.g., "NYCFC Academy" → "mls_next"). If the email mentions Aspire and the recruit's club is Girls Academy or unknown, use "ga_aspire" instead of "ga".
