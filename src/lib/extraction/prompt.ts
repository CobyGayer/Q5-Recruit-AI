...
- For club_level: Classify the club/league tier as one of: "mls_next", "ecnl", "ecrl" (ECNL Regional League), "ga" (Girls/Boys Academy), "ga_aspire" (Girls Academy Aspire subleague), "regional", "other", "unknown". Infer from the club name if needed (e.g., "NYCFC Academy" → "mls_next"). If the email mentions Aspire and the recruit's club is Girls Academy or unknown, use "ga_aspire" instead of "ga". If the email mentions ECRL, ECNL-RL, or ECNL regional and the recruit's club is ECNL, use "ecrl" instead of "ecnl".
- For club_level: Classify the club/league tier as one of: "mls_next", "mls_next_homegrown", "mls_next_academy", "ecnl", "ecrl" (ECNL Regional League), "ga" (Girls/Boys Academy), "ga_aspire" (Girls Academy Aspire subleague), "regional", "other", "unknown". Infer from the club name if needed (e.g., "NYCFC Academy" → "mls_next"). If the club is MLS Next, prefer sublevels only when there is explicit evidence: the email or club name mentions "homegrown"/"home-grown" for homegrown, or mentions "MLS Next Academy" (or unambiguous MLS Next-specific "Academy") for academy. If unsure, return "mls_next".
